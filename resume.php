...
<nav class="navbar navbar-expand-md  fixed-left">
        ...
        <div class=" navbar-collapse collapse hide" id="navbarsExampleDefault">
            <ul class="navbar-nav lists" id="lists">
                ...
                <li class="nav-item active" data-target="resume">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12 py-4">
                    ...
                    <ul class="experience">
                        ...
                        <li class="py-2">
                            <span><i class="fa fa-check"></i>  From Octobrt 2019 - Now </span>
                            <p>Worked  as  a web designer (Front-End) at  Logic System company for Programming
                                (port said- Egypt).</p>
                            <span class="d-block">Projects :</span>
                                <ul class="py-1 Projects">
                                    <li>Logic System</li> |
                                <li>Edge</li> |
                                <li>Talent industrial</li> |
                                    <li>Mawarid Medical</li> |
                                    <li>Castellamar</li> |
                                    <li>Unisea</li> |
                                    <li>Euromage</li> |
                                    <li>Master</li>
                        ...
                        <li class="py-3">
                            <span><i class="fa fa-check"></i> From  june 2019 - September 2019</span>
                            <p>Worked  as  a web designer (Front-End) at Techco Art  company for Programming (port said- Egypt). </p>
                ...
                <div class="col-md-6 col-sm-12 py-4">
                    ...
                    <ul class="education">
                        <li class="py-2">
                            <span><i class="fa fa-check"></i> From 2012 - 2017 </span>
                            <p>
                                BSC of Engineering - Faculty of Engineering ,<br> El-Mansoura University Communication<br>
                                and Electronics
                                Department.
                            </p>
                        </li>
            ...
            <div class="skills">
              ...
              <div class="progress">
                   ...
                   <div class="progress">
                       <div class="progress-bar" role="progressbar" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100">Css</div>
                  </div>
                    <div class="progress">
                        <div class="progress-bar" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">Java Script</div>
                    </div>
                        <div class="progress">
                            <div class="progress-bar" role="progressbar" aria-valuenow="55" aria-valuemin="0" aria-valuemax="100">Vue.js</div>
                        </div>
                        <div class="progress">
                            <div class="progress-bar" role="progressbar" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100">Firebase</div>
                        </div>
                    </div>
                    <div class="col-md-6 col-xs-12">
                       <div class="progress">
                        <div class="progress-bar" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100">JQuery</div>
                    </div>
                        <div class="progress">
                            <div class="progress-bar" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">Material Design</div>
                        </div>
                    <div class="progress">
                        <div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">Sass</div>
                    </div>
                    <div class="progress">
                      <div class="progress-bar" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100">Bootstrap</div>
                   </div>

                        <div class="progress">
                            <div class="progress-bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">WordPress</div>
                        </div>
